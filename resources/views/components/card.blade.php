<div class="containerCard m-4">	
  ...
  <div class="product-image">
    <img src="{{$article->images->isNotEmpty() ? $article->images->first()->getUrl(300,300) : 'https://picsum.photos/id/' . $article->id . '/200/250'}}" alt="Immagine dell'articolo {{$article->title}}" class="custom-card-img  w-100 imgCard">
    <div class="info">
