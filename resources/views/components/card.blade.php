<div class="custom-card">
    ...
    <div class="custom-card-body">
        ...
        <h6 class="custom-card-subtitle">{{__('ui.price:')}} @formatPrice($article->price) €</h6>
        <div class="custom-card-actions">
            <a href="{{route('article.show',compact('article'))}}" class="custom-card-btn custom-card-btn-primary">{{__('ui.detail')}}</a>
